...
checkpoint_dir_1 = 'model_weight_rotation_v4.1/'
checkpoint_dir_2 = 'model_weight_rotation_v4.1/'
...
with tf.Session() as sess:
	...
	for i in range(50):
		...
		input_test = utils.load_image_com('/home/gaopeng/chair_rotation_plus_trans_test_true/chair_rotation_test/chair_rotation_test_%.2d.png' % i)[:,:,:3]
		...
		# input_Semantic_test
		input_Semantic_test = np.loadtxt('/home/gaopeng/chair_rotation_plus_trans_test_true/rendering_destination_rotation_trans.txt')
		...
		# input_c_test
		input_c_test = utils.load_image_com('../../chair_rotation_plus_trans_test_true/chair_rotation_true/' + 'chair_rotation_destination_%.2d.png' % i)[:,:,:3]
		...
		misc.imsave('../../chair_rotation_plus_trans_test_true/chair_trans_test_no_end_to_end/chair_trans_test_%.2d.png' % i , output_test_image)