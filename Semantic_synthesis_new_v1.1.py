...
checkpoint_dir_2 = 'model_weight_rotation_v4.0/'
...
with tf.Session() as sess:
	...
	for i in range(50):
		...
		# input_Semantic_test
		input_Semantic_test = np.loadtxt('/home/gaopeng/chair_rotation_plus_trans_test_true/rendering_destination_rotation_angle.txt')
		...
		misc.imsave('../../chair_rotation_plus_trans_test_true/chair_rotation_test/chair_rotation_test_%.2d.png' % i , output_test_image)